            ...
            return Dialog(
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  return Container(
                    width: isSmallScreen ? MediaQuery.of(context).size.width * 0.92 : 500,
                                ...
                                Row(
                                  children: [
                                    ...
                                    ElevatedButton(
                                      ...
                                      onPressed: isUpdatingRate ? null : _updateExchangeRate,
                    ...
                    child: StreamBuilder<List<Map<String, dynamic>>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (filteredProducts.isEmpty) {
                          return const Center(
                            child: Text('No hay productos disponibles', style: TextStyle(color: Colors.grey, fontSize: 16)),
                          );
                        }
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  'SKU: ${prod['sku'] ?? prod['id']?.toString().substring(0, 8) ?? '-'} | Stock: ${prod['stock'] ?? 0}',
